  ...
  <div>
    <el-row>
      <el-col :span="24">
        ...
        <!-- <el-input placeholder="请输入内容" class="search-input search "    v-model="search" >
          <el-button slot="append" icon="el-icon-search" @click="searchCate"></el-button>
        </el-input>-->
        <el-button type="primary" @click="AddCateGoods" round>添加分类</el-button>
      </el-col>
    </el-row>
    <br />
    <!-- 表格 -->
    <tree-table
      v-loading="loading"
      class="treeTable animated fadeInLeft"
